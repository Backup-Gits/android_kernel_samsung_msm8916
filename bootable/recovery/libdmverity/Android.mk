...
ifeq ($(TARGET_BOARD_PLATFORM_DMV),msm8976pro)
LOCAL_CFLAGS += -DUSE_SHA256
endif
endif
endif
...
ifeq ($(DMVERITY_USE_LDU),true)
LOCAL_CFLAGS += -DUSE_LDU
endif
...
ifeq ($(PRODUCT_TRUSTZONE_TYPE), $(filter eos2 exynos3xxx exynos4xxx exynos5xxx exynos7xxx exynos8xxx msm8952 msm8937 msm8953 msm8916 msm8974 msm8994 msm8996 msm8998 sdm660 msm89xx msm8x26 QC8064 QC8084,$(PRODUCT_TRUSTZONE_TYPE)))
LOCAL_STATIC_LIBRARIES += libdevkm
LOCAL_CFLAGS := -DUSE_LIBDEVKM
LOCAL_CFLAGS += -DUSE_KEYSESSION_API
endif
endif
...
ifeq ($(TARGET_SOC),exynos7885)
LOCAL_SRC_FILES := dm_verity_make_ext4fs_7885.py
endif
ifeq ($(TARGET_PROJECT), TRE)
